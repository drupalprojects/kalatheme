...
<div class="panel-display pirog clearfix <?php !empty($class) ? print $class : ''; ?>" <?php !empty($css_id) ? print "id=\"$css_id\"" : ''; ?>>
  ...
  <section class='section'>
    <div class='container'>
      <div class="pirog-container pirog-header clearfix panel-panel row">
        <div class="pirog-container-inner pirog-header-inner panel-panel-inner">
  ...
  <footer class='section' id='footer' role='contentinfo'>
    <div class='container'>
      <div class="pirog-container pirog-column-content pirog-column-content-row1 clearfix row">
        <div class="pirog-column-content-region pirog-column pirog-column1 panel-panel col-md-4">
        ...
        <div class="pirog-column-content-region pirog-column pirog-column2 panel-panel col-md-4">
        ...
        <div class="pirog-column-content-region pirog-column pirog-column3 panel-panel col-md-4">
