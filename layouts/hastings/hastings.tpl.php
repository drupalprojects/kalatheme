...
<div class="panel-display hastings clearfix <?php !empty($class) ? print $class : ''; ?>" <?php !empty($css_id) ? print "id=\"$css_id\"" : ''; ?>>
  ...
  <section class='section'>
    <div class='container'>
      <div class="hastings-container hastings-header clearfix panel-panel row">
        <div class="hastings-container-inner hastings-header-inner panel-panel-inner">
  ...
  <footer class='section' id='footer' role='contentinfo'>
    <div class='container'>
      <div class="hastings-container hastings-column-content hastings-column-content-row1 clearfix row">
        <div class="hastings-column-content-region hastings-column hastings-column1 panel-panel col-md-4">
        ...
        <div class="hastings-column-content-region hastings-column hastings-column2 panel-panel col-md-4">
        ...
        <div class="hastings-column-content-region hastings-column hastings-column3 panel-panel col-md-4">
