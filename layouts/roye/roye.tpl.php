...
<div class="panel-display roye clearfix <?php !empty($class) ? print $class : ''; ?>" <?php !empty($css_id) ? print "id=\"$css_id\"" : ''; ?>>
  ...
  <section class='section'>
    <div class='container'>
      <div class="roye-container roye-header clearfix panel-panel row">
        <div class="roye-container-inner roye-header-inner panel-panel-inner">
    ...
    <div class='container'>
      <div class='row'>
        <div class="roye-container roye-main roye-column-content clearfix">
          <div class="roye-column-content-region roye-content panel-panel col-md-6">
            <div class="roye-column-content-region-inner roye-content-inner panel-panel-inner">
              <?php print $content['column1']; ?>
            </div>
          </div>
          <div class="roye-column-content-region roye-sidebar panel-panel col-md-6">
  ...
  <footer class='section' id='footer' role='contentinfo'>
    <div class='container'>
      <div class="roye-container roye-column-content roye-column-content-row1 clearfix row">
        <div class="roye-column-content-region roye-column roye-column1 panel-panel col-md-4">
        ...
        <div class="roye-column-content-region roye-column roye-column2 panel-panel col-md-4">
        ...
        <div class="roye-column-content-region roye-column roye-column3 panel-panel col-md-4">
