...
<div class="panel-display rolph clearfix <?php !empty($class) ? print $class : ''; ?>" <?php !empty($css_id) ? print "id=\"$css_id\"" : ''; ?>>
  ...
  <section class='section'>
    <div class='container'>
      <div class="rolph-container rolph-quarter-content clearfix row">
        <div class="rolph-column-content-region rolph-quarter1 rolph-quarter panel-panel col-md-3">
        ...
        <div class="rolph-column-content-region rolph-quarter2 rolph-quarter panel-panel col-md-3">
          <div class="rolph-column-content-region-inner rolph-quarter2-inner rolph-quarter-inner panel-panel-inner">
            <?php print $content['quarter2']; ?>
          </div>
        </div>
        <div class="rolph-column-content-region rolph-quarter3 rolph-quarter panel-panel col-md-3">
        ...
        <div class="rolph-column-content-region rolph-quarter4 rolph-quarter panel-panel col-md-3">
