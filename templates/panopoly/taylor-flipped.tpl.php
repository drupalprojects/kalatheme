...
<div class="panel-display taylor-flipped-flipped clearfix <?php !empty($class) ? print $class : ''; ?>" <?php !empty($css_id) ? print "id=\"$css_id\"" : ''; ?>>
   <section class="section">
    <div class="container">
      <div class="row">
        <div class="col-md-12 taylor-flipped-header-area">
  ...
  <section class="section">
    <div class="container">
      <div class="row">
        <div class="col-md-3 taylor-flipped-quarter-1-area">
          <?php print $content['quarter1']; ?>
        </div>
        <div class="col-md-3 taylor-flipped-quarter-2-area">
          <?php print $content['quarter2']; ?>
        </div>
        <div class="col-md-6 taylor-flipped-half-area">
  ...
  <footer class="section" id="footer">
    <div class="container">
      <div class="row">
        <div class="col-md-12 taylor-flipped-footer-area">
