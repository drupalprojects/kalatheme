  ...
  <section class='section'>
    <div class='container'>
      ...
      <div class="bartlett-sidebar bartlett-column-content-region bartlett-column bartlett-container panel-panel">
        <div class="bartlett-sidebar-inner bartlett-column-content-region-inner bartlett-column-inner bartlett-container-inner panel-panel-inner col-md-4">
          <?php print $content['sidebar']; ?>
        </div>
      </div>

      <div class="bartlett-content-container bartlett-container">
        <div class="bartlett-column-content-region bartlett-content-header clearfix panel-panel col-md-8">
          <div class="bartlett-column-content-region-inner bartlett-content-header-inner panel-panel-inner">
            <?php print $content['contentheader']; ?>
          </div>
        </div>

        <div class="bartlett-content-container-column-container clearfix row">
          <div class="bartlett-column-content-region bartlett-content-column1 bartlett-column panel-panel col-md-4">
          ...
          <div class="bartlett-column-content-region bartlett-content-column2 bartlett-column panel-panel col-md-4">
