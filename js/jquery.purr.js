 ...
 *                                    removed once it is the top non-sticky notice in the list
                             default: 4000
 *  @param sticky             bool - Whether the notice should fade out on its
...
(function($) {
  $.purr = function(notice, options) {
    ...
    if (!options.sticky && !notice.hasClass('sticky')) {
    ...
    function notify() {
      ...
      notice.children('a.close', window.top.document).click(function() {
        removeNotice($(this).parent());
        return false;
      });
  ...
  $.fn.purr = function(options) {
    ...
    options.sticky = Drupal.settings.purr_messages.sticky || false;
